...
import com.fruitProject.fruit.Controller.viewobject.UserVO;
...
import com.fruitProject.fruit.service.Impl.UserServiceImpl;
import com.fruitProject.fruit.service.OrderInfoService;
import com.fruitProject.fruit.service.model.OrdersModel;
...
public class UserController {
    ...
    @ResponseBody
    public CommonReturnType login(@RequestBody UserModel testUserModel) throws Exception {

        String telephone = AesEncryptUtil.desEncrypt(testUserModel.getTelephone());
        String password = AesEncryptUtil.desEncrypt(testUserModel.getEncrptPassword());
